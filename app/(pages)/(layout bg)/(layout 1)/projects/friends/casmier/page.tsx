...
export default function Casmier() {
  return (<>
    ...
    <main className={`${stylesWin9x.window} ${styles.casmier} ${stylesLayout.children}`}>
      <div className={stylesWin9x.title}>Twitter Art*st</div> 
      <div style={{ position: "relative" }}>
        <Overlay>
          <span style={{ textAlign: 'center', color:"black"}}>
            ...
            <Image src={imageCryingSad} width={250} height={250} alt="mald" style={{width:"25%", height: "auto", margin:8}} />
          </span>
        </Overlay>
      ...
      <div>
        <Stickyboard documentId="cas" routePath="/projects/friends/casmier" />
      </div>
